...
FILES:${PN}:append:virtclass-multilib-riscv64 = " \
...
FILES:${PN}-staticdev:append:virtclass-multilib-riscv64 = " ${libdir}/clang/${MAJOR_VER}.${MINOR_VER}.${PATCH_VER}/lib/linux/*.a"

FILES:${PN}-dev:append:virtclass-multilib-riscv64 = " ${datadir} ${libdir}/clang/${MAJOR_VER}.${MINOR_VER}.${PATCH_VER}/lib/linux/*.syms \
...
# Copy headers to the resource-dir as well as we now set the resource-dir variable and point it to ${libdir}
